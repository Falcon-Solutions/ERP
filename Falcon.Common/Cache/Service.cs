...
namespace Falcon.Common.Caching
{
    public static class Service
    {
        public static void LoadStaticCacheForDropdown(Dictionary<string, List<dynamic>> masterData)
        {
        ...
        public static bool UpdateAllCacheObjects(Dictionary<string, List<dynamic>> masterData)
        {
